...
<html lang="pt-br">
    ...
    <div class="flex items-center justify-center min-h-screen py-28">
        <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
            ...
            <div>
                <form action="../controllers/UserController.php?acao=register" method="POST">
                    ...
                    <input type="text" name="email" class="w-full px-4 py-2 mb-4 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-yellow-400"/>
